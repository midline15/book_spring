...
public class ECommentService {
    ...
    public void createEComment(EpisodeComment eComment) { //e북 댓글 생성
        eCommentRepository.save(eComment);
    }
    public EpisodeComment getEComment(Long id) { //e북 댓글 조회
        return eCommentRepository.findById(id).get();
    }
    public void deleteEComment(Long id) { //e북 댓글 삭제
        eCommentRepository.deleteById(id);
    }
    public void updateEComment(EpisodeComment eComment) { //e북 댓글 수정
        eCommentRepository.save(eComment);
    }
    public List<EpisodeComment> getECommentList() { //e북 댓글 조회
